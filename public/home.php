                ...
                <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                    <h6 class="dropdown-header d-flex align-items-center">
                        ...
                        <div class="dropdown-user-details">
                            <div class="dropdown-user-details-name"><?php echo $_SESSION['user']['username'] ?></div>
                    ...
                    <a class="dropdown-item" href="<?php echo '../php/app/logout.php'; ?>">
            ...
            <nav class="sidenav shadow-right sidenav-light">
                ...
                <div class="sidenav-footer">
                    <div class="sidenav-footer-content">
                        ...
                        <div class="sidenav-footer-title"><?php echo $_SESSION['user']['username'] ?></div>
                    </div>
                </div>
            </nav>
        </div>
                    ...
                    <div class="container">
                        <div class="page-header-content pt-4">
                            <?php
                                ...
                                if (isset($_GET['alert-activation'])) {
                                    ...
                                    <div class="alert alert-success alert-icon" role="alert">
                                        ...
                                        <div class="alert-icon-content">
                                            <h6 class="alert-heading">Registro de la cuenta completado</h6>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-xl-8 col-xxl-12">
                                            <div class="text-center text-xl-left text-xxl-center px-4 mb-4 mb-xl-0 mb-xxl-4">
                                                <h1 class="text-primary">Welcome to <?php echo CONFIG['APP_NAME']; ?>!</h1>
                                ...
                                <div class="card-body">
                                    <div class="timeline timeline-xs">
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-item-content">
                                                New user
                                                <a class="font-weight-bold text-dark" href="#!"><?php echo $_SESSION['user']['username'] ?></a>
                                                has registered
                                            </div>
                                        </div>
                                        <!-- Timeline Item 4-->
